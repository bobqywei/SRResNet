...
parser.add_argument("--gt", type=str, help="ground truth images directory")
parser.add_argument("--mask", type=str, help="mask images directory")
parser.add_argument("--input", type=str, help="input images directory")
